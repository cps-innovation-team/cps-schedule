...
class NowClass: Identifiable, Equatable {
    ...
    var nextBlockColor: UIColor
    var nextBlockTeacher: String
    var nextBlockRoom: String
    
    init(startBlockDate: Date, currentBlockName: String, currentBlockTime: String, currentBlockDate: Date, currentBlockColor: UIColor, currentBlockTeacher: String, currentBlockRoom: String, nextBlockName: String, nextBlockTime: String, nextBlockDate: Date, nextBlockColor: UIColor, nextBlockTeacher: String, nextBlockRoom: String) {
