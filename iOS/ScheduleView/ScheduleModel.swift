...
struct passingBlockScheduleView: View {
    ...
    var body: some View {
        Capsule()
            .foregroundColor(colorScheme == .light ? Color(systemAdaptive.tinted(amount: 0.25)) : Color(systemAdaptive.shaded(amount: 0.25)))
    }
}
                            ...
                            VStack {
                                ...
                                HStack {
                                    ...
                                    VStack {
                                        Text(name)
                                            .font(.headline)
                                            .foregroundColor(colorScheme == .light ? Color(systemAdaptive.shaded(amount: 0.4)) : Color(systemAdaptive.tinted(amount: 0.6)))
                                            .fontWeight(.bold)
                                            .multilineTextAlignment(.center)
                                            .minimumScaleFactor(0.5)
                                        Text(timeRange)
...
//                            .shadow(color: Color("AccentColor"), radius: 0, x: -3, y: -3)
//                            .shadow(color: Color("Hibiscus"), radius: 0, x: 3, y: 3)
                        VStack {
                            Text(name)
                                .font(.headline)
                                .foregroundColor(colorScheme == .light ? Color(color.shaded(amount: 0.4)) : Color(color.tinted(amount: 0.6)))
...
//                            Text(name)
//                                .font(.headline)
//                                .foregroundColor(Color("SystemEnvironment"))
//                                .fontWeight(.bold)
//                                .multilineTextAlignment(.center)
//                                .minimumScaleFactor(0.5)
//                            Text(timeRange)
