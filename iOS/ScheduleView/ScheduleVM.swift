...
// MARK: Weekend View
struct ScheduleViewWeekend: View {
            ...
            GeometryReader { metrics in
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        ...
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Lunch", timeRange: "11:45 - 12:15", block: "Lunch", date: date, array: $array)
                            .frame(height: metrics.size.height * (30/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                    }
                    VStack(spacing: 0) {
                        ...
                        universalBlock(boolValue: UserDefaults(suiteName: "group.TheCollegePreparatorySchool.ScheduleApp")?.bool(forKey: "FFreeKey") ?? false ,height: longBlock, color: UserDefaults(suiteName: "group.TheCollegePreparatorySchool.ScheduleApp")?.colorForKey(key: "FColorKey") ?? systemF, name: UserDefaults(suiteName: "group.TheCollegePreparatorySchool.ScheduleApp")?.string(forKey: "FNameKey") ?? "F-Block", timeRange: "1:45 - 3:00", block: "F", date: date, array: $array)
                            .frame(height: metrics.size.height * (75/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Open", timeRange: "3:00 - 3:30", block: "Afternoon Open", date: date, array: $array)
                            .frame(height: metrics.size.height * (30/total))
                    }
                }
            }
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        universalBlock(boolValue: false, height: mediumBlock, color: UserDefaults(suiteName: "group.TheCollegePreparatorySchool.ScheduleApp")?.colorForKey(key: "AssemblyColorKey") ?? systemTeal, name: UserDefaults(suiteName: "group.TheCollegePreparatorySchool.ScheduleApp")?.string(forKey: "AssemblyNameKey") ?? "Assembly", timeRange: "11:05 - 11:35", block: "Assembly", date: date, array: $array)
                            .frame(height: metrics.size.height * (30/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Lunch", timeRange: "11:35 - 12:25", block: "Lunch", date: date, array: $array)
        ...
        VStack {
            ...
            GeometryReader { metrics in
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Open", timeRange: "11:15 - 11:45", block: "Morning Open", date: date, array: $array)
                            .frame(height: metrics.size.height * (30/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Lunch", timeRange: "11:45 - 12:15", block: "Lunch", date: date, array: $array)
                            .frame(height: metrics.size.height * (30/total))
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        universalBlock(boolValue: false, height: mediumBlock, color: UserDefaults(suiteName: "group.TheCollegePreparatorySchool.ScheduleApp")?.colorForKey(key: "CompassColorKey") ?? systemTeal, name: UserDefaults(suiteName: "group.TheCollegePreparatorySchool.ScheduleApp")?.string(forKey: "CompassNameKey") ?? "Compass", timeRange: "11:05 - 11:55", block: "Compass", date: date, array: $array)
                            .frame(height: metrics.size.height * (50/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Lunch", timeRange: "11:55 - 12:25", block: "Lunch", date: date, array: $array)
                            .frame(height: metrics.size.height * (30/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                    }
                    VStack(spacing: 0) {
    ...
    var body: some View {
        VStack {
            ...
            GeometryReader { metrics in
                VStack(spacing: 0) {
                    VStack(spacing: 0) {
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Assessment", timeRange: "8:30 - 9:30", block: "Morning Assessment", date: date, array: $array)
                    ...
                    VStack(spacing: 0) {
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Lunch", timeRange: "11:20 - 12:15", block: "Lunch", date: date, array: $array)
                            .frame(height: metrics.size.height * (55/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                    }
                    VStack(spacing: 0) {
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Assessment", timeRange: "12:15 - 1:15", block: "Afternoon Assessment", date: date, array: $array)
                            .frame(height: metrics.size.height * (60/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        passingBlockScheduleView()
                            .frame(height: metrics.size.height * (5/total))
                        ...
                        passingBlockScheduleView()
                            .frame(height: metrics.size.height * (5/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Faculty Collab", timeRange: "2:15 - 3:30", block: "Faculty Collaboration", date: date, array: $array)
                            .frame(height: metrics.size.height * (75/total))
                    }
                }
            }
        ...
        VStack {
            ...
            GeometryReader { metrics in
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Open", timeRange: "11:05 - 11:35", block: "Morning Open", date: date, array: $array)
                            .frame(height: metrics.size.height * (30/total))
                        Spacer().frame(height: metrics.size.height * (spacing/total))
                        universalBlock(boolValue: false, height: lunchBlock, color: systemGray, name: "Lunch", timeRange: "11:35 - 12:25", block: "Lunch", date: date, array: $array)
                            .frame(height: metrics.size.height * (50/total))
