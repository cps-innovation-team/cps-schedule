...
class SportType: Hashable {
    ...
    init(name: String, emoji: String, color: NSColor) {
        self.name = name
        self.emoji = emoji
        self.color = color
    }
...
func getSportType(input: String) -> SportType {
    ...
    switch switcher {
        ...
        case let str where str.contains("boys varsity cross country"):
            return SportType(name: "Boys Cross Country", emoji: "🏃", color: NSColor(Color("Cross Country")))
            
        case let str where str.contains("girls varsity cross country"):
            return SportType(name: "Girls Cross Country", emoji: "🏃‍♀️", color: NSColor(Color("Golf")))
            
        case let str where str.contains("coed varsity golf"):
            return SportType(name: "Golf", emoji: "🏌️", color: NSColor(Color("Boys Tennis")))
            
        case let str where str.contains("girls varsity tennis"):
            return SportType(name: "Girls Tennis", emoji: "🎾", color: NSColor(Color("Girls Tennis")))
            
        case let str where str.contains("boys varsity tennis"):
            return SportType(name: "Boys Tennis", emoji: "🎾", color: NSColor(Color("Boys Tennis")))
            
        case let str where str.contains("track and field"):
            return SportType(name: "Track & Field", emoji: "🏃", color: NSColor(Color("Cross Country")))
            
        case let str where str.contains("track & field"):
            return SportType(name: "Track & Field", emoji: "🏃", color: NSColor(Color("Cross Country")))
            
        case let str where str.contains("varsity baseball"):
            return SportType(name: "Baseball", emoji: "⚾️", color: NSColor(Color("Baseball")))
            
        case let str where str.contains("softball"):
            return SportType(name: "Softball", emoji: "🥎", color: NSColor(Color("Softball")))
            
        case let str where str.contains("boys varsity volleyball"):
            return SportType(name: "Boys Volleyball", emoji: "🏐", color: NSColor(Color("Boys Volleyball")))
            
        case let str where str.contains("girls varsity volleyball"):
            return SportType(name: "Girls Volleyball", emoji: "🏐", color: NSColor(Color("Girls Volleyball")))
            
        case let str where str.contains("girls jv volleyball"):
            return SportType(name: "Girls Volleyball", emoji: "🏐", color: NSColor(Color("Girls Volleyball")))
            
        case let str where str.contains("boys varsity swimming"):
            return SportType(name: "Boys Swimming", emoji: "🏊", color: NSColor(Color("Golf")))
            
        case let str where str.contains("girls varsity swimming"):
            return SportType(name: "Girls Swimming", emoji: "🏊‍♀️", color: NSColor(Color("Girls Swimming")))
            
        case let str where str.contains("boys varsity soccer"):
            return SportType(name: "Boys Soccer", emoji: "⚽", color: NSColor(Color("Boys Soccer")))
            
        case let str where str.contains("girls varsity soccer"):
            return SportType(name: "Girls Soccer", emoji: "⚽", color: NSColor(Color("Girls Soccer")))
            
        case let str where str.contains("boys varsity basketball"):
            return SportType(name: "Boys Basketball", emoji: "🏀", color: NSColor(Color("Boys Basketball")))
            
        case let str where str.contains("boys jv basketball"):
            return SportType(name: "Boys Basketball", emoji: "🏀", color: NSColor(Color("Boys Basketball")))
            
        case let str where str.contains("girls varsity basketball"):
            return SportType(name: "Girls Basketball", emoji: "🏀", color: NSColor(Color("Girls Basketball")))
