...
func detectCategory(input: String, agenda: Bool) -> ClubTag {
    ...
    if affinitiesBool { return(ClubTag(text: "affinities", symbol: "tag.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
    else if activismBool { return(ClubTag(text: "activism", symbol: "tag.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
    else if stemBool { return(ClubTag(text: "stem", symbol: "tag.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
    else if poleconBool { return(ClubTag(text: "politics", symbol: "tag.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
    else if lifestyleBool { return(ClubTag(text: "lifestyle", symbol: "tag.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
    else if artsBool { return(ClubTag(text: "arts", symbol: "tag.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
    else if assemblyBool { return(ClubTag(text: "community", symbol: "person.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
    else if commonBool { return(ClubTag(text: "community", symbol: "person.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
    else { return(ClubTag(text: "club", symbol: "tag.fill", color: NSColor(Color("AccentColor")), sharebool: false, sharelink: input, agenda: agenda)) }
}
...
class ClubTag: Hashable {
    ...
    init(text: String, symbol: String, color: NSColor, sharebool: Bool, sharelink: String, agenda: Bool) {
        self.text = text
        self.symbol = symbol
        self.color = color
